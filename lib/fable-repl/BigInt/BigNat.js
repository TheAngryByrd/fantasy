...
export function removeFactor(x, a, n) {
  ...
  if (patternInput[1] < patternInput[0] + n) {
    ...
    const f = patternInput[0] === 0 ? patternInput[1] === n ? ~~(patternInput_1[1][n] / patternInput_1[0][0]) : fromNumber(patternInput_1[1][patternInput[1]], false).mul(baseNi64).add(fromNumber(patternInput_1[1][patternInput[1] - 1], false)).div(fromNumber(patternInput_1[0][0], false)).toNumber() : patternInput[1] === patternInput[0] + n ? ~~(patternInput_1[1][patternInput[1]] / (patternInput_1[0][patternInput[0]] + 1)) : fromNumber(patternInput_1[1][patternInput[1]], false).mul(baseNi64).add(fromNumber(patternInput_1[1][patternInput[1] - 1], false)).div(fromNumber(patternInput_1[0][patternInput[0]], false).add(fromBits(1, 0, false))).toNumber();
    if (f === 0) {
